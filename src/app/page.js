...
export default function QuizApp() {
  ...
  return (
    ...
    >
      <div
        className="rounded-[50px] p-12 max-w-7xl w-full relative"
        style={{
          background:
      ...
      >
        {currentQuestion === 0 && (
          <div className="absolute left-40 top-3/4 -translate-y-1/4 -translate-x-16 z-10">
        ...
        >
          <div className="text-center mb-10 w-4xl justify-center mx-auto">
            <h1
          ...
          <div className="mb-8 w-4xl justify-center mx-auto">
          ...
          <div
            className="rounded-xl p-6 mb-8 w-4xl justify-center mx-auto"
            style={{
              background: "linear-gradient(to right, #C6E9F7, #E5F8FF)",
          ...
          <div className="space-y-4 mb-8 w-4xl justify-center mx-auto">
            {quizData[currentQuestion].options.map((option, index) => (
              <motion.button
                ...
                className="w-full p-5 rounded-xl text-center"
